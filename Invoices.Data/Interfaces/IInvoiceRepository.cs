...
namespace Invoices.Data.Interfaces
{
    ...
    {
        IList<Invoice> FindByBuyerId(ulong buyerId, int limit);
        IList<Invoice> FindBySellerId(ulong sellerId, int limit);
        IList<Invoice> FindByProductName(string productName,int limit);
        IList<Invoice> FindByMinPrice(int minPrice, int limit);
        IList<Invoice> FindByMaxPrice(int maxPrice, int limit);
